...
namespace Ex04.Menus.Interfaces
{
    public class ConsoleUtils
    {
        ...
        public static int ShowMenuAndGetUserChoice(string i_Title, List<MenuItem> i_MenuItems, bool i_MainMenu = false)
        {
            Console.WriteLine("** {0} **", i_Title);
            Console.WriteLine("-----------------------------------");
            printMenuItems(i_MenuItems);
            Console.WriteLine("0 - {0}", i_MainMenu ? "Exit" : "Back");
            int userChoice = getInputAndValidate(i_MenuItems.Count);
        ...
        private static int getInputAndValidate(int i_Count)
        {
